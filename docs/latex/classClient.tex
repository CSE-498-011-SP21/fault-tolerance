...
\index{Client@{Client}!connect\_servers@{connect\_servers}}
\index{connect\_servers@{connect\_servers}!Client@{Client}}
\doxysubsubsection{\texorpdfstring{connect\_servers()}{connect\_servers()}}
...
\index{Client@{Client}!getPrimary@{getPrimary}}
\index{getPrimary@{getPrimary}!Client@{Client}}
