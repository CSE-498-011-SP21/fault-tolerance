...
private:
  ...
  ft::Server* handlePrimaryFailure(ft::Server* primServer, ft::Server* expNewPrimary = nullptr);
  int open_backup_endpoints(ft::Server* primServer = NULL, char state = 'b', int timeout = 0, int* ret = NULL);
